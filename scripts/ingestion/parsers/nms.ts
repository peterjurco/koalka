...
/**
 * Parse NMS HTML: blog/category pages with poll tables (same pattern as Focus).
 */
export function parseNMS(docs: FetchedDocument[], options?: ParseOptions | null): ParseResult {
